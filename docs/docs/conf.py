...
# Fortytwo build configuration file
...
linkcheck_ignore = [
    ...
    r"https://github.com/collective/fortytwo/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/collective/fortytwo",
    ...
    "repository_url": "https://github.com/collective/fortytwo",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/collective/fortytwo/edit/main/docs/",
# }
...
ogp_site_name = "Fortytwo Documentation"
ogp_type = "website"
...
htmlhelp_basename = "FortytwoDocumentation"
...
latex_documents = [
    (
        "index",
        "FortytwoDocumentation.tex",
        "Fortytwo Documentation",
